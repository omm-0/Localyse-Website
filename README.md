<div align="center">
<h1>📍 Localyse</h1>
<p><b>Hyperlocal Influencer Marketing Platform</b></p>

</div>

📖 About The Project

Localyse is a beautifully designed, high-performance landing page for a conceptual Hyperlocal Influencer Marketing platform. It bridges the gap between local businesses (restaurants, gyms, salons) and verified micro-influencers in their specific cities or neighborhoods.

The project features a modern UI/UX design with smooth scroll animations, a custom lerp cursor, interactive bento grids, and responsive layouts, all built from scratch using pure HTML, CSS, and vanilla JavaScript without any heavy frameworks.
...
├── script.js        # Logic for animations, cursor, scroll observer, and UI interactions
